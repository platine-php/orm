...
/**
 * ShareOne class tests
 *
 * @group core
 * @group database
 */
class ShareOneTest extends PlatineTestCase
{
    public function testUnLinkWhereForeignAndJunctionIsNull(): void
    {
        $entity = $this->getEntityInstance(['id' => 1, 'user_id' => 2]);
        $entityClass = get_class($entity);
        $e = new ShareOne($entityClass);
        ...
        $e->unlink($dataMapper, $entity);
    }

    public function testLinkWhereForeignAndJunctionIsNull(): void
    {
        $entity = $this->getEntityInstance(['id' => 1, 'user_id' => 2]);
        $entityClass = get_class($entity);
        $e = new ShareOne($entityClass);
        ...
        $e->link($dataMapper, $entity);
    }

    public function testLinkWhereForeignIsNotNull(): void
    {
        ...
        $e = new ShareOne($entityClass, $foreignKey);
    ...
    public function testGetLoaderCustomerForeignKey(): void
    {
        ...
        $e = new ShareOne(get_class($this->getEntityInstance()), $foreignKey);
        ...
        $this->assertArrayHasKey('hidden_owner_related1', $keys[0]);
        $this->assertArrayHasKey('hidden_owner_related2', $keys[0]);
    }
    ...
    public function testGetResultCallbackAndForeignKeyNull(): void
    {
        ...
        $e = new ShareOne(get_class($this->getEntityInstance()));
